...
class EventEmitter {
  ...
  removeCurrentListener() {
    ...
    this.removeSubscription(this._currentSubscription as EmitterSubscription);
  }
  ...
  listeners(eventType: string): EmitterSubscription[] {
    const subscriptions : EmitterSubscription[] = (this._subscriber.getSubscriptionsForType(eventType)) as any;
