...
import { getMethodName } from 'react-eflow/lib/method'
...
function execInitStores (component, customPropsMapping) {
  const state = getState.call(component, null, null, null, customPropsMapping)
...
* */
const wrapComponent = function (_Component, updaters, customPropsMapping) {
  // 装饰方式处理
