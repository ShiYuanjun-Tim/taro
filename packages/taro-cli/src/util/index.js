...
exports.UPDATE_PACKAGE_LIST = [
  '@tarojsrn/taro',
  '@tarojsrn/async-await',
  '@tarojsrn/cli',
  '@tarojsrn/components',
  '@tarojsrn/components-rn',
  '@tarojsrn/taro-h5',
  '@tarojsrn/taro-swan',
  '@tarojsrn/taro-alipay',
  '@tarojsrn/plugin-babel',
  '@tarojsrn/plugin-csso',
  '@tarojsrn/plugin-sass',
  '@tarojsrn/plugin-less',
  '@tarojsrn/plugin-stylus',
  '@tarojsrn/plugin-uglifyjs',
  '@tarojsrn/redux',
  '@tarojsrn/redux-h5',
  '@tarojsrn/taro-redux-rn',
  '@tarojsrn/taro-router-rn',
  '@tarojsrn/taro-rn',
  '@tarojsrn/rn-runner',
  '@tarojsrn/router',
  '@tarojsrn/taro-weapp',
  '@tarojsrn/webpack-runner',
  ...
  '@tarojsrn/mobx-h5',
  '@tarojsrn/mobx-rn',
  '@tarojsrn/mobx-common',
  '@tarojsrn/mobx-prop-types'
]
